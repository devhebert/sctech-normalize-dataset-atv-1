...
def _rules_executor(
    ...
    if stats is not None:
        numerical_rules_applied = _apply_missing_numeric_value_rule_to_products_using_median_or_zero(products, stats,
                                                                                                     strategy=strategy)
        print(
...
def _aggregate_category_statistics(products: List[Dict[str, str]]) -> ProductCategoryStats:
...
def normalize_values(products: List[Dict[str, str]]) -> List[Dict[str, str]]:
    ...
    código existente.
    """
    stats: ProductCategoryStats = _aggregate_category_statistics(products)
